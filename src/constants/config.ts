...
export const BRAND_CONFIG = {
  ...
  DOMAIN: 'ananyadesigner.com',
  DEFAULT_ADMIN_EMAIL: 'admin@ananyadesigner.com',
  META_TITLE: 'Ananya Designer | Premium Indian Fashion',
  META_DESCRIPTION: "Discover premium Indian fashion at Ananya Designer. Shop handpicked sarees, lehengas, kurtas, and more from India's finest weavers and designers.",
  GUEST_ID_KEY: 'ananya_guest_id',
} as const;
